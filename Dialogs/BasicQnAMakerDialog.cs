...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerPreviewDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerPreviewDialog() : base(new QnAMakerService(new QnAMakerAttribute(RootDialog.GetSetting("QnAAuthKey"), Utils.GetAppSetting("QnAKnowledgebaseId"), "Nenhum resultado encontrado na base de conhecimento.", 0.2)))
        { }
    }
